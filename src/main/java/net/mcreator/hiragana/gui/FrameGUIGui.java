...
import net.mcreator.hiragana.procedures.FrameSubtractCountFromSlot8Procedure;
import net.mcreator.hiragana.procedures.FrameSubtractCountFromSlot7Procedure;
import net.mcreator.hiragana.procedures.FrameSubtractCountFromSlot6Procedure;
import net.mcreator.hiragana.procedures.FrameSubtractCountFromSlot5Procedure;
import net.mcreator.hiragana.procedures.FrameSubtractCountFromSlot4Procedure;
import net.mcreator.hiragana.procedures.FrameSubtractCountFromSlot3Procedure;
import net.mcreator.hiragana.procedures.FrameSubtractCountFromSlot2Procedure;
import net.mcreator.hiragana.procedures.FrameSubtractCountFromSlot1Procedure;
import net.mcreator.hiragana.procedures.FrameSubtractCountFromSlot0Procedure;
import net.mcreator.hiragana.procedures.AddBlockFrameProcedure;
...
public class FrameGUIGui extends HiraganaModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public FrameGUIGui(HiraganaModElements instance) {
		super(instance, 138);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("frame_gui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, FrameGUIGuiWindow::new));
	}
	...
	public void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.openContainer instanceof GuiContainerMod) {
			...
			double z = entity.getPosZ();
			{
				...
				FrameSubtractCountFromSlot0Procedure.executeProcedure($_dependencies);
			}
		}
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 88, 53) {
				@Override
				public ItemStack onTake(PlayerEntity entity, ItemStack stack) {
					ItemStack retval = super.onTake(entity, stack);
		...
		if (buttonID == 0) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				AddBlockFrameProcedure.executeProcedure($_dependencies);
			}
		}
	}
		...
		if (slotID == 1 && changeType == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				FrameSubtractCountFromSlot1Procedure.executeProcedure($_dependencies);
			}
		}
		...
		if (slotID == 2 && changeType == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				FrameSubtractCountFromSlot2Procedure.executeProcedure($_dependencies);
			}
		}
		...
		if (slotID == 3 && changeType == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				FrameSubtractCountFromSlot3Procedure.executeProcedure($_dependencies);
			}
		}
		...
		if (slotID == 4 && changeType == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				FrameSubtractCountFromSlot4Procedure.executeProcedure($_dependencies);
			}
		}
		...
		if (slotID == 5 && changeType == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				FrameSubtractCountFromSlot5Procedure.executeProcedure($_dependencies);
			}
		}
		...
		if (slotID == 6 && changeType == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				FrameSubtractCountFromSlot6Procedure.executeProcedure($_dependencies);
			}
		}
		...
		if (slotID == 7 && changeType == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				FrameSubtractCountFromSlot7Procedure.executeProcedure($_dependencies);
			}
		}
		...
		if (slotID == 8 && changeType == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				FrameSubtractCountFromSlot8Procedure.executeProcedure($_dependencies);
			}
		}
